...
| **getDuration**  | Duration in milliseconds since the typing started.                                                                                                                                                                                         |           `getDuration()`            | `0` if the typing has yet to start. Current duration since the typing started if typing has yet to end. When the typing ended, the duration will be equivalent to `endTime - startTime.` |
